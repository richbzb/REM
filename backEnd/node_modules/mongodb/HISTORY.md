...
* Added socketTimeoutMS and connectTimeoutMS to socket options for repl_set.js and em.js
...
* Correctly emit errors from em.js only wrapping errors that are strings
